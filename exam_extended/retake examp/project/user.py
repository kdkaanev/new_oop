class User:
    ...
    def first_name(self, value):
        self.__validate_name_not_empty(value, "First name cannot be empty!")
    ...
    def last_name(self, value):
        self.__validate_name_not_empty(value, "Last name cannot be empty!")
    ...
    def driving_license_number(self, value):
        self.__validate_name_not_empty(value, "Driving license number is required!")
